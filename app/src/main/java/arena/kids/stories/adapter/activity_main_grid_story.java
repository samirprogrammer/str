...
public class activity_main_grid_story extends RecyclerView.Adapter<activity_main_grid_story.ViewHolder> {
    ...
    public activity_main_grid_story(Activity act2, String[] prgmNameList, String[] prgIndex,String pgName) {
        act = act2;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.activity_grid_main_story, parent, false);
...
//        holder.myView.setBackgroundColor(color);
        ...
        if(prgmNameListNew[position].length()>=20)
            holder.txtCatTitle.setText(prgmNameListNew[position].substring(0,19)+"..");
    ...
    public void goToCateogory() {
        Intent i = new Intent(cnx, arena.kids.stories.activities.CatActivity.class);
        i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        i.putExtra("pgname", "Panch");
        i.putExtra("pgurl", "Panch");
        i.putExtra("newID", "Panch");
        cnx.startActivity(i);
//System.out.println("OnClickCat"+t.getText());
    }
    @Override
