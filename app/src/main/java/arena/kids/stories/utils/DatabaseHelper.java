...
import kids.stories.utils.model.Note;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "stories_db";
    ...
    public Note getNote(long id) {
        ...
        Cursor cursor = db.query(Note.TABLE_NAME,
                new String[]{Note.COLUMN_ID, Note.COLUMN_TITLE, Note.COLUMN_TIMESTAMP},
                Note.COLUMN_ID + "=?",
